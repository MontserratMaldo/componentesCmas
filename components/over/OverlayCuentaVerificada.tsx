...
export const OverlayCuentaVerificada: React.FC<OverlayCuentaVerificadaProps> = ({
  visible,
  onClose,
}) => {
  return (
    <Modal visible={visible} transparent animationType="fade">
      <View style={styles.overlay}>
        <View style={styles.card}>
          ...
          <Text style={[Typography.title1, styles.title]}>Cuenta verificada</Text>
          <Text style={[Typography.text, styles.subtitle]}>con éxito</Text>
